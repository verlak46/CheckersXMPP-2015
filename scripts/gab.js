...
var BOSH_SERVICE = 'http://polvatronic:7070/http-bind/';
...
var Gab = {
    ...
    on_message: function (message) {
        ...
        // Si el mensaje es {...} Es un movimiento
        if (text.charAt(0) === '{') {
    ...
    movePiece: function (text) {

        move_send = false;
        console.log("movement");
        oldPiece_X = text.charAt(1);
        oldPiece_Y = text.charAt(2);
        newPiece_X = text.charAt(3);
        newPiece_Y = text.charAt(4);


        selectedPiece = board[oldPiece_X][oldPiece_Y];
        $antSquare = $('div.square_dark[data-positionX="'+oldPiece_X+'"][data-positionY="'+oldPiece_Y+'"]');
        $selectedSquare = $('div.square_dark[data-positionX="'+newPiece_X+'"][data-positionY="'+newPiece_Y+'"]');
        selectedPiece.move(newPiece_X,newPiece_Y);
        move_send = true;
        can_move = true;
    }
};
...
$(document).ready(function () {
    ...
    $('.roster-contact').live('click', function () {
        ...
        // Se inicializa el jid del jugador al que enviar los movimientos
        jid_send = jid;
    ...
    $('#disconnect').click(function () {
        $('#chat-area').append("<div> Disconnecting... </div>");
...
$(document).bind('connect', function (ev, data) {
    ...
    $('#chat-area').append("<div> Connecting... </div>");
